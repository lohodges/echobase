...
aws sns subscribe \
    --topic-arn arn:aws:sns:us-east-2:746669200167:echobase-db-incidents \
    --protocol email \
    --notification-endpoint lonnie@robustci.com
...
Alarm Creation (example)
        ...
        aws cloudwatch put-metric-alarm \
          --alarm-name echobase-db-connection-failure \
...
1.1 Confirm Alert
  ...
  --alarm-names echobase-db-connection-failure \
